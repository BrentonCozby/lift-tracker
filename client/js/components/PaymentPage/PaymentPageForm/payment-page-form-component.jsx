...
import { stripeChargeCustomer } from '../../../actions-and-reducers/stripe/stripe-action-creators.js'
...
export class PaymentPageForm extends Component {
    ...
    static propTypes = {
        ...
        stripeChargeCustomer: PropTypes.func,
    ...
    onSubmit(e) {
        ...
        this.props.stripeChargeCustomer(this.props.stripe, {
            stripe_customer_id: this.props.user.payment.stripe_customer_id,
